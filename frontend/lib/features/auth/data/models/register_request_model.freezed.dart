...
mixin _$RegisterRequestModel {
 ...
 String get username; String get password; String get displayName; String get role; String? get email; String? get phone; String? get grade; String? get className; String? get studentId;
...
/// Create a copy of RegisterRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? password = null,Object? displayName = null,Object? role = null,Object? email = freezed,Object? phone = freezed,Object? grade = freezed,Object? className = freezed,Object? studentId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  String password,  String displayName,  String role,  String? email,  String? phone,  String? grade,  String? className,  String? studentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterRequestModel() when $default != null:
return $default(_that.username,_that.password,_that.displayName,_that.role,_that.email,_that.phone,_that.grade,_that.className,_that.studentId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  String password,  String displayName,  String role,  String? email,  String? phone,  String? grade,  String? className,  String? studentId)  $default,) {final _that = this;
switch (_that) {
case _RegisterRequestModel():
return $default(_that.username,_that.password,_that.displayName,_that.role,_that.email,_that.phone,_that.grade,_that.className,_that.studentId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  String password,  String displayName,  String role,  String? email,  String? phone,  String? grade,  String? className,  String? studentId)?  $default,) {final _that = this;
switch (_that) {
case _RegisterRequestModel() when $default != null:
return $default(_that.username,_that.password,_that.displayName,_that.role,_that.email,_that.phone,_that.grade,_that.className,_that.studentId);case _:
  return null;
...
class _RegisterRequestModel implements RegisterRequestModel {
  const _RegisterRequestModel({required this.username, required this.password, required this.displayName, this.role = 'student', this.email, this.phone, this.grade, this.className, this.studentId});
...
/// Create a copy of RegisterRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? password = null,Object? displayName = null,Object? role = null,Object? email = freezed,Object? phone = freezed,Object? grade = freezed,Object? className = freezed,Object? studentId = freezed,}) {
