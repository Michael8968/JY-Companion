...
mixin _$PersonaBinding {
  ...
  $PersonaBindingCopyWith<PersonaBinding> get copyWith =>
      _$PersonaBindingCopyWithImpl<PersonaBinding>(
          this as PersonaBinding, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PersonaBinding &&
...
abstract mixin class $PersonaBindingCopyWith<$Res> {
  factory $PersonaBindingCopyWith(
          PersonaBinding value, $Res Function(PersonaBinding) _then) =
      _$PersonaBindingCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String userId,
...
extension PersonaBindingPatterns on PersonaBinding {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PersonaBinding value)? $default, {
...
class _PersonaBinding implements PersonaBinding {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PersonaBindingCopyWith<_PersonaBinding> get copyWith =>
      __$PersonaBindingCopyWithImpl<_PersonaBinding>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PersonaBinding &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.personaId, personaId) ||
                other.personaId == personaId) &&
...
/// @nodoc
abstract mixin class _$PersonaBindingCopyWith<$Res>
    implements $PersonaBindingCopyWith<$Res> {
  factory _$PersonaBindingCopyWith(
          _PersonaBinding value, $Res Function(_PersonaBinding) _then) =
      __$PersonaBindingCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
