...
mixin _$CreateConversationModel {
  ...
  $CreateConversationModelCopyWith<CreateConversationModel> get copyWith =>
      _$CreateConversationModelCopyWithImpl<CreateConversationModel>(
          this as CreateConversationModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CreateConversationModel &&
...
abstract mixin class $CreateConversationModelCopyWith<$Res> {
  factory $CreateConversationModelCopyWith(CreateConversationModel value,
          $Res Function(CreateConversationModel) _then) =
      _$CreateConversationModelCopyWithImpl;
  @useResult
...
extension CreateConversationModelPatterns on CreateConversationModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CreateConversationModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _CreateConversationModel() when $default != null:
        return $default(_that.agentType, _that.personaId, _that.title);
      case _:
        return orElse();
    }
  }
...
class _CreateConversationModel implements CreateConversationModel {
  const _CreateConversationModel(
      {required this.agentType, this.personaId, this.title});
  factory _CreateConversationModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CreateConversationModelCopyWith<_CreateConversationModel> get copyWith =>
      __$CreateConversationModelCopyWithImpl<_CreateConversationModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CreateConversationModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CreateConversationModel &&
            (identical(other.agentType, agentType) ||
                other.agentType == agentType) &&
            (identical(other.personaId, personaId) ||
                other.personaId == personaId) &&
...
/// @nodoc
abstract mixin class _$CreateConversationModelCopyWith<$Res>
    implements $CreateConversationModelCopyWith<$Res> {
  factory _$CreateConversationModelCopyWith(_CreateConversationModel value,
          $Res Function(_CreateConversationModel) _then) =
      __$CreateConversationModelCopyWithImpl;
  @override
  @useResult
  $Res call({String agentType, String? personaId, String? title});
}
