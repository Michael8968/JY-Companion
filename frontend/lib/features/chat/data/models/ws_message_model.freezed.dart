...
mixin _$WsIncomingMessage {
  ...
  $WsIncomingMessageCopyWith<WsIncomingMessage> get copyWith =>
      _$WsIncomingMessageCopyWithImpl<WsIncomingMessage>(
          this as WsIncomingMessage, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, type, conversationId, content, contentType);
...
abstract mixin class $WsIncomingMessageCopyWith<$Res> {
  factory $WsIncomingMessageCopyWith(
          WsIncomingMessage value, $Res Function(WsIncomingMessage) _then) =
      _$WsIncomingMessageCopyWithImpl;
  @useResult
  $Res call(
      {String type,
...
extension WsIncomingMessagePatterns on WsIncomingMessage {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WsIncomingMessage value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String type, String? conversationId, String? content,
            String? contentType)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _WsIncomingMessage() when $default != null:
        return $default(
            _that.type, _that.conversationId, _that.content, _that.contentType);
      case _:
        return orElse();
    }
  }
...
class _WsIncomingMessage implements WsIncomingMessage {
  const _WsIncomingMessage(
      {required this.type,
      this.conversationId,
      this.content,
      this.contentType = 'text'});
  factory _WsIncomingMessage.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WsIncomingMessageCopyWith<_WsIncomingMessage> get copyWith =>
      __$WsIncomingMessageCopyWithImpl<_WsIncomingMessage>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WsIncomingMessageToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$WsIncomingMessageCopyWith<$Res>
    implements $WsIncomingMessageCopyWith<$Res> {
  factory _$WsIncomingMessageCopyWith(
          _WsIncomingMessage value, $Res Function(_WsIncomingMessage) _then) =
      __$WsIncomingMessageCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String type,
...
mixin _$WsOutgoingMessage {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $WsOutgoingMessageCopyWith<WsOutgoingMessage> get copyWith =>
      _$WsOutgoingMessageCopyWithImpl<WsOutgoingMessage>(
          this as WsOutgoingMessage, _$identity);
...
abstract mixin class $WsOutgoingMessageCopyWith<$Res> {
  factory $WsOutgoingMessageCopyWith(
          WsOutgoingMessage value, $Res Function(WsOutgoingMessage) _then) =
      _$WsOutgoingMessageCopyWithImpl;
  @useResult
...
extension WsOutgoingMessagePatterns on WsOutgoingMessage {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WsOutgoingMessage value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String type, Map<String, dynamic>? data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _WsOutgoingMessage implements WsOutgoingMessage {
  const _WsOutgoingMessage(
      {required this.type, final Map<String, dynamic>? data})
      : _data = data;
  factory _WsOutgoingMessage.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WsOutgoingMessageCopyWith<_WsOutgoingMessage> get copyWith =>
      __$WsOutgoingMessageCopyWithImpl<_WsOutgoingMessage>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WsOutgoingMessageToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$WsOutgoingMessageCopyWith<$Res>
    implements $WsOutgoingMessageCopyWith<$Res> {
  factory _$WsOutgoingMessageCopyWith(
          _WsOutgoingMessage value, $Res Function(_WsOutgoingMessage) _then) =
      __$WsOutgoingMessageCopyWithImpl;
  @override
  @useResult
  $Res call({String type, Map<String, dynamic>? data});
}
