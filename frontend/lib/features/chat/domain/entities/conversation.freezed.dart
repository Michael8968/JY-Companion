...
class _Conversation implements Conversation {
  const _Conversation({required this.id, required this.agentType, this.personaId, this.title, required this.status, required this.messageCount, this.lastMessageAt, required this.createdAt});
